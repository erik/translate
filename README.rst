...
This project is made available under the Apache License 2.0 (subject to change
before the project hits any point of usability). See the LICENSE file for more
information.
